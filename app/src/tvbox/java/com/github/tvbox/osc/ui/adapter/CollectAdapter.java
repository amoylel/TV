...
public class CollectAdapter extends BaseQuickAdapter<Keep, BaseViewHolder> {
    public CollectAdapter() {
        super(R.layout.item_grid, new ArrayList<>());
    }

    @Override
    protected void convert(BaseViewHolder helper, Keep item) {
        ...
        if (ApiConfig.get().getSite(item.getSiteKey())!=null) {

...
public abstract class BaseLazyFragment extends Fragment implements CustomAdapt {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (null == rootView) {
            rootView = getBinding(inflater, container).getRoot();;
        }
        isViewCreated = true;
        return rootView;
    }
    ...
    protected void setLoadSir(View view) {
        setLoadSir(view, (Callback.OnReloadListener) v -> {});
    }
    protected void setLoadSir(View view,  Callback.OnReloadListener callback) {
        if (mLoadService == null) {
            mLoadService = LoadSir.getDefault().register(view, callback);
        }
    }
    protected void setLoadSir2(View view) {
        setLoadSir2(view, (Callback.OnReloadListener) v -> {});
    }
